 // 获取当前页面的语言部分
  ...
  const updateLinks = (lang) => {
    ...
    // Sign-in Link
    document.getElementById('sign-in-link').querySelector('a').href = `/${lang}/users/sign_in?return_to=%2F${lang}`;
    document.getElementById('sign-in-mobile-link').querySelector('a').href = `/${lang}/users/sign_in?return_to=%2F${lang}`;
  };
